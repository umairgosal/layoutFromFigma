...
function One(){
  return (
    <Fragment>
      ...
      <div className='h-[464px] flex flex-row relative items-center justify-center p-36'>
            <h1 className=' font-extrabold text-[52px]'>Guiding You Through Tokenization</h1>
          <div className='flex flex-col'>
              <h2 className='font-bold text-[40px] leading-[44px] mb-10'>Tokenization requires a nuanced understanding of the technological and legal frameworks.</h2>
              <p className='text-[16px]'>Leveraging our deep expertise in blockchain technology, digital assets, and regulatory frameworks, we guide our clients through the complexities of the tokenization process, ensuring that their ventures into the digital asset space are both legally sound and strategically poised for success.</p>
        </div>
      </div>
      <div className='h-[736px] flex justify-center'>
        <div className='size-full'>
          <img className='mx-auto' src={circleImg} alt="" />
        </div>
        <div className='p-10 size-full'>
          <h1 className='font-extrabold text-[56px] mb-10'>Comprehensive Guidance</h1>
          <p className='text-[16px] mb-12'>Our firm provides comprehensive guidance, making the tokenization of real-world assets seamless for our clients. From real estate and fine art to commodities and beyond, we understand the nuances of various asset classes and the specific legal considerations each entails. </p>
          <h2 className='font-bold text-[24px] mb-8'>Our practice is built on:</h2>
            <div className='flex flex-col'>
      ...
      <div className='relative w-[1440px] h-[592px]'>
        <img className='absolute bottom-0'  src={screenThree} alt="" />
        <div className='absolute'>
          <h1 className='font-extrabold text-[56px] translate-x-[135px] translate-y-[70px]'>Tokenize Any Assets, Anywhere</h1>
          <h3 className='font-bold text-[24px] translate-x-[135px] translate-y-[100px] w-[770px] h-[135px]'>The promise of tokenization is vast, offering unprecedented opportunities for asset liquidity, access, and efficiency. Our firm is at the vanguard of this revolution, equipped to tokenize a diverse range of real-world assets.</h3>
          <p className='text-[20px] translate-x-[135px] translate-y-[150px] w-[835px] h-[128px]'>Regardless of where your assets are located or what they consist of, our team has the expertise to guide you through the tokenization process. We ensure that your assets are transformed into digital tokens in a manner that maximizes their value and accessibility while maintaining legal compliance and operational efficiency.</p> 
        </div>
      </div>
      <div className='w-[1440px] h-[400px]'>
        <div className='w-[600px] h-[96px] flex flex-row'>
          <div className='flex flex-col'>
            <h1 className='w-[600px] h-[96px] translate-x-[135px] translate-y-[74px] font-extrabold text-[40px]'>Access Efficient Legal Structures for Tokenization</h1>
            <p className='w-[570px] h-[100px] translate-x-[135px] translate-y-[130px] text-[16px]'>Finding the right legal structure for tokenization is crucial for the success of any digital asset venture. Our law firm specializes in crafting efficient, innovative legal frameworks that not only protect your assets but also enhance their marketability and appeal to investors.</p>
          </div>
          <div className=''>
            <p className='w-[570px] h-[126px] translate-x-[235px] translate-y-[215px] text-[16px]'>Whether it's navigating the complexities of securities law, establishing digital asset trusts, or creating DAOs for asset management, we provide tailored solutions that meet the specific needs of your tokenization project. Our expertise ensures that your venture is built on a solid legal foundation, ready to thrive in the digital economy.</p>
          </div>
        </div>
      </div>
      <div className='w-[1440px] h-[640px]'>
        <div className='flex flex-row'>
          <img className='w-[726px] h-[726px]' src={screenfour} alt="" />
          <div>
            <h1 className='w-[454px] h-[192px] translate-x-[135px] translate-y-[74px] font-extrabold text-[52px]'>Let Us Deal with Regulatory Compliance</h1>
            <p className='w-[470px] h-[250px] translate-x-[135px] translate-y-[80px]'>The regulatory landscape for tokenized assets is complex and ever-changing. Our law firm takes the burden of regulatory compliance off your shoulders, allowing you to focus on your business while we ensure that your tokenization project meets all legal requirements. From securities regulations and AML/KYC compliance to cross-border transaction laws, our team is adept at navigating the regulatory maze. We work diligently to keep your project compliant, informed by the latest legal developments and regulatory insights, ensuring that your tokenized assets are not just innovative but also secure and legally sound.</p>
          </div>
        </div>
      </div>
      <div className='w-[1440px] h-[768px] relative'>
        <img className='h-screen w-screen' src={screenfive} alt="" />
        <div className='absolute top-1'>
          <h1 className='w-[355px] h-[160px] translate-x-[550px] translate-y-[80px] font-extrabold text-[72px]'>Selected Services</h1>
          <p className='w-[770px] h-[100px] translate-x-[350px] translate-y-[160px] text-center text-[20px]'>Explore our specialized services in the realm of asset tokenization, where we bridge the gap between traditional finance and the digital world. Our expert team provides comprehensive legal support for the tokenization of real-world assets, ensuring secure and compliant transactions in this innovative space.</p>
          <div className='translate-x-[650px] translate-y-[450px]'>
      ...
      <div className='w-[1440px] h-[464px]'>
        <div className='grid grid-cols-2 font-bold text-[24px]'>
          <div className='w-[570px] h-[80px] rounded-xl border mb-10 translate-x-[155px] translate-y-[80px] p-4 flex flex-row items-center'>
          ...
          <div className='w-[570px] h-[80px] rounded-xl border mb-10 translate-x-[35px] translate-y-[80px] p-4 flex items-center'>
            <h3 className='mr-40'>Releasing tokenization products</h3>
            <svg width="15px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 12H20M12 4V20" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <div className='w-[570px] h-[80px] rounded-xl border mb-10 translate-x-[155px] translate-y-[80px] p-4 flex  items-center'>
      ...
      <div className='w-[1440px] h-[768px] relative'>
        <div className='absolute flex flex-col translate-x-[135px] translate-y-[180px]'>
          <h1 className='w-[268px] h-[160px] font-extrabold text-[72px] mb-10'>Other Details</h1>
          <p className='w-[585px] h-[200px] text-[20px]'>In the transformative field of asset tokenization, Aurum Law Firm is a trusted legal advisor, guiding clients through the complexities of digitizing real-world assets. Our selected cases, publications, and accolades in this area demonstrate our expertise in navigating the legal intricacies of tokenization, ensuring compliance and innovation in every transaction.</p>
        </div>
        <img src={screenSeven} alt="" />
      </div>
      <div className='w-[1440px] h-[672px]'>
        <div className='flex flex-row translate-y-[70px]'>
          <img src={screenSix} alt="" />
          <div className='flex flex-col border p-10 rounded-xl translate-x-[135px] '>
            <h2 className='w-[306px] h-[134px] font-extrabold text-center text-[24px] translate-y-[120px]'>Advised a tokenization project on the tokenization of real estate in Dubai, UAE,</h2>
            <p className='w-[306px] h-[72px] text-[16px] text-center translate-y-[180px]'>and developed a tailored tokenization model for the client with a focus on regulatory compliance and scalability.</p>
          </div>
        </div>
      </div>
    </Fragment>
